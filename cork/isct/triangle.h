...
/*  `triangleadoubleist':  An array of triangle area constraints; one double per */
/*    triangle.  Input only.                                                 */
...
/*      used (with no number following), `triangleadoubleist' must point to a  */
...
/*      initialized.  `triangleadoubleist' may be ignored.                     */
...
struct CORK_EXPORT triangulateio {
...
void CORK_EXPORT triangulate(char *, struct triangulateio *, struct triangulateio *,
                 struct triangulateio *);
void CORK_EXPORT trifree(void *memptr);
